    ...
    <AuthenticatedLayout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="overflow-hidden ma-8 w-100 bg-white rounded-lg border shadow-xs"
                >
                    ...
                    <div class="overflow-x-auto mx-8 text-xl">
                        <div class="flex mb-4">
                            ...
                            <span>
                                {{ date_formatter(form.departure_time) }}
                            </span>
                            <span class="font-bold mr-5 ml-5">
                                Departure Time:</span
                            >
                            <span>
                                {{ date_formatter(form.arrival_time) }}
                            </span>
                        </div>
                        <div class="flex mb-4">
                            <span class="font-bold mr-5"> Origin:</span>
                            <span> {{ form.origin }} </span>
                            <span class="font-bold mr-5 ml-20">
                                Destination:</span
                            >
                        ...
                        <div class="flex mb-4">
                            <div v-if="form.total_reserve > 0">
                                <form @submit.prevent="update">
                                    <InputLabel
                                        for="reserve_count"
                                        value="Seat to Reserve"
                                    />
                                    <TextInput
                                        type="number"
                                        v-model="reserve_count"
                                    />
                                    <div class="block mt-4">
                                        <PrimaryButton
                                            type="submit"
                                            v-if="reserve_count > 0"
                                        >
                                            Reserve
                                        </PrimaryButton>
                                    </div>
                                ...
                                <div class="flex mb-4">
                                    <p class="text-3xl text-red-500 text-bold">
                                        Total Price
                                        {{
                                            toCurrency(
                                                compute_total_price(
